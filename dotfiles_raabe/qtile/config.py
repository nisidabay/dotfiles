...
keys = [
    ...
    Key(
        [mod, "shift"],
        "d",
        lazy.spawn("dmenu_run -i -fn Monospace-14"),
        desc="Launch dmenu",
    ),
    ...
    Key(
        [mod],
        "m",
        lazy.spawn("sh " + home + "/dotfiles/.settings/mail.sh"),
        desc="Launch Neomutt",
    ),
    Key(
        [mod],
        "n",
        lazy.spawn("sh " + home + "/dotfiles/.settings/filemanager.sh"),
        desc="Launch Filemanager",
    ),
    Key(
        [mod, "shift"],
        "w",
        lazy.spawn(home + "/dotfiles/qtile/scripts/wallpaper.sh"),
        desc="Update Theme and Wallpaper",
    ),
    Key(
        [mod, "control"],
        "l",
        lazy.spawn(home + "/dotfiles/qtile/scripts/bender-i3.sh"),
        desc="Lock Screen",
    ),
    Key(
        [mod, "control"],
        "w",
        lazy.spawn(home + "/dotfiles/qtile/scripts/wallpaper.sh select"),
...
groups.append(
    ScratchPad(
        ...
        [
            ...
            DropDown(
                "vimwiki",
                "alacritty -e bash -i -c 'source ~/.bash_aliases; ww'",
                x=0.3,
                y=0.1,
                width=0.40,
                height=0.4,
...
keys.extend(
    [
        ...
        Key([mod], "F10", lazy.group["6"].dropdown_toggle("calcurse")),
        Key([mod], "F11", lazy.group["6"].dropdown_toggle("vimwiki")),
        Key([mod], "F12", lazy.group["6"].dropdown_toggle("xpad")),
    ]
)
...
widget_list = [
    ...
    widget.TextBox(
        **decor_left,
        ...
        mouse_callbacks={
            "Button1": lambda: qtile.cmd_spawn(
                "bash " + home + "/dotfiles/.settings/browser.sh"
            )
        },
    ),
    widget.TextBox(
        **decor_left,
        ...
        mouse_callbacks={
            "Button1": lambda: qtile.cmd_spawn(
                "bash " + home + "/dotfiles/.settings/filemanager.sh"
            )
        },
    ),
    widget.WindowName(
