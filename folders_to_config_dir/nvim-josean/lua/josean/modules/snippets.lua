-- ~/.config/nvim/lua/josean/modules/snippets.lua
local M = {}
...
function M.get_snippet_name(filetype)
  local snippet_name =
    vim.fn.input("Snippet: ", "", "customlist,v:lua.require'josean.modules.snippets'.complete_snippet_names")
...
vim.api.nvim_set_keymap(
  "n",
  "<leader>ssl",
  ':lua require("josean.modules.snippets").list_snippets()<CR>',
  { noremap = true, silent = true, desc = "List snippets" }
)
vim.api.nvim_set_keymap(
  "n",
  "<leader>ssa",
  ':lua require("josean.modules.snippets").add_snippet()<CR>',
  { noremap = true, silent = true, desc = "Add snippet" }
)
vim.api.nvim_set_keymap(
  "n",
  "<leader>sse",
  ':lua require("josean.modules.snippets").edit_snippet()<CR>',
  { noremap = true, silent = true, desc = "Edit snippet" }
)
vim.api.nvim_set_keymap(
  "n",
  "<leader>ssd",
  ':lua require("josean.modules.snippets").delete_snippet()<CR>',
  { noremap = true, silent = true, desc = "Delete snippet" }
)
vim.api.nvim_set_keymap(
  "n",
  "<leader>ssi",
  ':lua require("josean.modules.snippets").insert_snippet()<CR>',
